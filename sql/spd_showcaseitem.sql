...
CREATE TABLE `showcaseitem` (
  `showcaseItemid` varchar(15) NOT NULL,
  `itemid` varchar(15) NOT NULL,
  `qty` int(11) NOT NULL,
  PRIMARY KEY (`showcaseItemid`),
  KEY `showcaseitem_itemid_fk_idx` (`itemid`),
  CONSTRAINT `showcaseitem_itemid_fk` FOREIGN KEY (`itemid`) REFERENCES `item` (`itemID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-06-29  0:01:33
