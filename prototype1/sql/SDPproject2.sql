...
INSERT INTO `item` VALUES ('100','tenant01','Big Apple','a big aplle',10.1),('120','tenant01','coffe','Black coffe',20),('200','tenant02','hat','not green',151),('300','tenant01','airr','light as airr',40),('400','tenant02','banana','banana in a showcase',20),('500','tenant02','tea bag','Everone want tea bag',54);
...
INSERT INTO `rentinfo` VALUES ('001','tenant01','2020-06-01',10,'sht001','sht'),('002','tenant01','2020-06-01',10,'cwb001','cwb'),('003','tenant01','2020-06-01',10,'mka001','mka'),('004','tenant01','2020-06-01',10,'mkb001','mkb'),('005','tenant01','2020-06-01',10,'kwf001','kwf'),('006','tenant02','2020-06-02',10,'cwb002','cwb');
...
INSERT INTO `reservation` VALUES ('001','cwb002','tenant01');
...
INSERT INTO `showcaseitem` VALUES ('','','',0,0,0,1),('cwb001','cwb','100',2,5,55,0),('cwb001','cwb','120',5,5,5,1),('cwb002','cwb','200',3,2,5,1),('kwf001','kwf','200',3,2,5,1),('mka001','mka','300',1,4,5,0),('mkb001','mkb','400',7,2,9,1),('sht001','sht','500',10,0,10,1);
...
-- Dump completed on 2020-07-06  1:36:58
